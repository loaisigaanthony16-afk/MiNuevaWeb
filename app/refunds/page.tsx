...
const sections: LegalSection[] = [
  {
    ...
    body: [
      [
        "Cancelás el pedido por el chat antes de que salga a entrega.",
  ...
  },
  {
    ...
    body: [
      "Si un producto no funciona, llega dañado o no es el que pediste, escribinos por el chat del pedido dentro de las 48 horas de recibirlo con una foto o video y tu referencia VIBE-XXXX.",
  ...
  },
  {
    ...
    body: [
      `Si ves un cargo que no reconocés o tuviste un problema con tu pedido, escribinos primero por ${LEGAL.channel}. Lo resolvemos más rápido que un reclamo con tu banco.`,
    ],
  },
];
